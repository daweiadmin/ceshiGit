          ...
          <div class="span12">
            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-title">
                ...
                <div class="caption"><i class="icon-edit"></i>抽奖记录</div>
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <th style="text-align: center;">抽中奖励</th>
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        <td style="text-align: center;"><?php echo ($vo["actname"]); ?></td>
                        <td style="text-align: center;"><?php echo ($vo["number"]); ?></td>
                        <td style="text-align: center; "><?php echo ($vo["wx_name"]); ?>-<?php echo ($vo["sex"]); ?></td>
                        <td style="text-align: center;"><?php echo (prize_value($vo["id"])); ?></td>
