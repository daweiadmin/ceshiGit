...
<!-- 
  ...
  <div class="page-container row-fluid">
          ...
          <div class="span12">
            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-title">
                ...
                <div class="caption"><i class="icon-edit"></i>资金流水</div>
              ...
              <div class="portlet-body">
                ...
                <div class="clearfix" style="height: 50px;">
                  ...
                  <div class="btn-group">
                    <button type="button" class="btn blue " style="margin-right: 10px;">账户余额：<?php echo ($shops); ?></button>
                   <a href="/index.php/Shop/shop/recharge">
                    <button type="button" class="btn green ">去充值</button>
                    </a>
                   <form class="sidebar-search" style="display:inline-block; float:right; margin-left:10px; " method="post" action="/index.php/Shop/Member/daili_index">
                     <input type="text" placeholder="用户昵称 / 姓名" name="search" style="width:200px; display:inline-block; height:24px;"/>
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <th style="text-align: center;">资金变动</th>
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        ...
                        <?php if($vo[moneytype] == 1): ?><span style="color: green;">账户充值</span>
                        <?php else: ?>
                         <span style="color: blue;">分配资金</span><?php endif; ?>
                        </td>
                        <td style="text-align: center; color: blue;">
                        <?php if($vo[moneytype] == 1): ?><span style="color: green;">+<?php echo ($vo["money"]); ?></span>
                        <?php else: ?>
                         <span style="color: red;">-<?php echo ($vo["money"]); ?></span><?php endif; ?>
                        </td>
                        <td style="text-align: center;"><?php echo ($vo["full"]); ?></td>
                        <td style="text-align: center; color: blue;"><?php echo ($vo["content"]); ?></td>
    ...
    $('.suo').click(function(){
     ...
     var url = "/index.php/Shop/Member/suo";
     var jump_url = "/index.php/Shop/Member/daili_index";
     var data = {'id':id};
    ...
    $('.jie').click(function(){
     ...
     var url = "/index.php/Shop/Member/jie";
     var jump_url = "/index.php/Shop/Member/daili_index";
     var data = {'id':id};
     $.post(url,data,function(result){
      if(result.status==1){
  ...
  $('.change_pwd').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Shop/Member/change';
     var jump_url = '/index.php/Shop/Member/daili_index';
     var data={'id':id}
     layer.open({
        type:0,
...
<script type="text/javascript">
  $('.kai').click(function(){
   ...
   // alert(chai_num);
    var url = '/index.php/Shop/Member/chaifen';
    var jump_url = '/index.php/Shop/Member/index';
...
<script type="text/javascript">
  $('#addcode').click(function(){
    ...
    //alert(shuliang);
    var url = '/index.php/Shop/Member/add';
    var jump_url = '/index.php/Shop/Member/index';
...
/*   $('#add').click(function(){
  ...
  $('.del').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Shop/Member/del';
     var jump_url = '/index.php/Shop/Member/index';
     var data={'id':id}
     layer.open({
        type:0,
    ...
    var url="/index.php/Shop/Member/bdel";
    var jump_url="/index.php/Shop/Member/index";
        layer.open({
        type:0,
        title:'批量删除',
