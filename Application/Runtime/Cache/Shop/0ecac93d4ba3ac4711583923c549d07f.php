                ...
                <div class="clearfix" style="height: 50px;">
                  ...
                  <div class="btn-group">
                    ...
                    <!--  <button id="delall" class="btn red" style="margin-left:20px;">
                     ...
                     <form class="sidebar-search" style="display:inline-block; float:right; margin-left:10px; " method="post" action="/index.php/Shop/Code/daili_index">
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        ...
                        <td style="text-align: center;">
                          <?php if($vo['activity_id'] == 0): ?><button type="button" class="btn green mini" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#chaifen<?php echo ($vo["id"]); ?>">拆分</button>
                          <?php else: ?>
                            <a href="/index.php/Shop/Code/code_info?code_num=<?php echo ($vo["id"]); ?>"><button type="button" class="btn blue mini">二维码</button></a><?php endif; ?>
                          <button type="button" class="btn yellow mini daochu_img" attr-id="<?php echo ($vo["id"]); ?>" attr-num="<?php echo ($vo["code_number"]); ?>">导出</button>
     ...
     <div class="modal-backdrop fade in zhezhao" style="text-align: center; display:none;">
      ...
          }  
        ...
        $('.daochu_img').click(function(){
         ...
         var url = "/index.php/Shop/Code/daochu";
         var data = {'code_num_id':id,'code_number':num};
         $.post(url,data,function(result){
          if(result.status==1){
              var jump_url = "/index.php/Shop/Code/downFile?file="+result.datas;
              //关闭遮罩层
