        ...
        <div class="row-fluid">
          ...
          <div class="span12">
                ...
                <form action="#" class="form-horizontal" id="form">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" class="span6 m-wrap" style="width:300px;" name="name" id="name" value="" placeholder="10个汉字以内" />
                   ...
                   <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" class="span6 m-wrap" style="width:300px;" name="content" id="content"  value=""/>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="date" class="span6 m-wrap" style="width:150px;" name="start_date" /> 至 <input type="date" class="span6 m-wrap" style="width:150px;" name="end_date" />
                  ...
                  <div >
                    <label class="control-label">适用门店：</label>
                                        <!-- direction 方向 -->
                    <div class="controls">
                       <?php if(is_array($store)): $i = 0; $__LIST__ = $store;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="radio">

                          <input type="checkbox" name="store[]" class="store" value="<?php echo ($vo["id"]); ?>"  />
            ...
            font-size: 200px;cursor: pointer;">
                      <input type="hidden" class="imgurl" name="ticket_picture">
                      
                        <span style="color: blue; margin-left: 20px;">*图片大小最大6M</span>
                    </div>
                     <div class="hidd" style=" margin-left: 180px; display: none;" >
                        <img src="" alt="" class="imgpic" width="80" height="40">
                     </div>
                  </div>
                  <div class="control-group" style="margin-top:20px;">
                    ...
                    <span style="background: blue;color: #fff;padding: 15px 10px;line-height: 35px;cursor: pointer; font-size: 14px;">上传文件</span>
                      <input type="file" class="imgfiles" style="position:absolute;right: 0px;top: 0px;opacity: 0;-ms-filter: 'alpha(opacity=0)';
            font-size: 200px;cursor: pointer;">
                      <input type="hidden" class="imgurl" name="link_picture">
                 ...
                 <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" class="span6 m-wrap" style="width:300px;" name="link" id="link" value=""/>
