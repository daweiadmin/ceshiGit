...
<!-- 
              ...
              <div class="portlet-body form">
                ...
                <form action="#" class="form-horizontal" id="form">
                  ...
                  <div class="control-group">
                    ...
                    <label class="control-label">门店联系方式</label>
                  ...
                  <div class="form-actions">
                    ...
                    <button type="button" class="btn blue" id="submit" onclick="edit_save()">确认修改</button>

                    <a href="/index.php/Shop/User/trans"><button type="button" class="btn">Cancel</button></a>
  ...
  <script>
   ...
   function edit_save(){
     ...
     var phone = $('#phone').val();
     var data = {'id':id,'name':name,'address':address,'phone':phone};
     var url = '/index.php/Shop/User/store_save';
     var jump_url = '/index.php/Shop/User/store';
    if(!name){
      dialog.error('请输入门店名称');return false;  
       }
    if(!address){
      dialog.error('请输入门店地址');return false;  
       }
      if(!phone){
      dialog.error('请输入门店联系方式');return false;  
       }
