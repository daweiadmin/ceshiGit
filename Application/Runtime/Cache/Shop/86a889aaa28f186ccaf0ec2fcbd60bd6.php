...
<!-- 
                ...
                <form action="#" class="form-horizontal" id="form">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" class="span6 m-wrap" style="width:300px;" name="username" id="username" value="<?php echo ($data["username"]); ?>" readonly />
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" class="span6 m-wrap" style="width:300px;" name="name" id="name" value="<?php echo ($data["name"]); ?>"/>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" class="span6 m-wrap" style="width:300px;" name="link_man" id="link_man" value="<?php echo ($data["link_man"]); ?>"/>
                 ...
                 <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" class="span6 m-wrap" style="width:300px;" name="phone" id="phone" value="<?php echo ($data["phone"]); ?>"/>
                   ...
                   <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" class="span6 m-wrap" style="width:300px;" name="email" id="email" value="<?php echo ($data["email"]); ?>"/>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" class="span6 m-wrap" style="width:300px;" name="address" id="address" value="<?php echo ($data["address"]); ?>"/>
                  ...
                  <div class="control-group" style="margin-top:20px;">
                    ...
                    <div class="controls">
                      ...
                      <input type="hidden" class="imgurl" name="picture">
                       <div class="hidd" style="">
                        <img src="<?php echo ($data["logo"]); ?>" alt="" class="imgpic" width="70" height="70">
                       </div>
                   ...
                   <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="date" class="span6 m-wrap" style="width:300px;" name="end_time" id="end_time" value='<?php echo date("Y-m-d",$data[end_time]);?>'/>
                  ...
                  <div class="form-actions">
                     <input type="hidden" class="span6 m-wrap" style="width:300px;" name="shop_id" id="shop_id" value="<?php echo ($data["id"]); ?>"/>
                    <button type="button" class="btn blue" id="submit" onclick="submit_2()">保存</button>
                     
                    <a href="/index.php/Shop/User/index"><button type="button" class="btn">返回</button></a>
  ...
  <!-- END CONTAINER -->
   ...
   function submit_2(){
     var url = '/index.php/Shop/User/save';
     var jump_url = '/index.php/Shop/User/index';
...
//厂家图片上传
            function uploadimg(imgUrlId,nameid,imgpic,hid){  
                ...
                $.ajax({
                    url: "/index.php/Shop/product/upload",
                    type: 'POST',
                    cache: false,
                    data: formData,
                    dataType: 'text',
