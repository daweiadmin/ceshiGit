...
<!-- 
  ...
  <div class="page-container row-fluid">
            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-body">
                ...
                <div class="clearfix" style="height: 50px;">
                  ...
                  <div class="btn-group">
                     <button type="button" class="btn blue sel" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#addclass">添加门店</button>

                     <form class="sidebar-search" style="display:inline-block; float:right; margin-left:10px; " method="post" action="/index.php/Shop/User/daili_index">
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        ...
                        <td style="text-align: center;">
                           <a href="/index.php/Shop/User/edit_store?store_id=<?php echo ($vo["id"]); ?>"><button type="button" class="btn blue mini">修改</button></a>
    ...
    $('.suo').click(function(){
     ...
     var url = "/index.php/Shop/User/suo";
     var jump_url = "/index.php/Shop/User/daili_index";
     var data = {'id':id};
    ...
    $('.jie').click(function(){
     ...
     var url = "/index.php/Shop/User/jie";
     var jump_url = "/index.php/Shop/User/daili_index";
     var data = {'id':id};
     $.post(url,data,function(result){
      if(result.status==1){
  ...
  $('.change_pwd').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Shop/User/change';
     var jump_url = '/index.php/Shop/User/daili_index';
     var data={'id':id}
     layer.open({
        type:0,
...
<script type="text/javascript">
  function add_stores(){
    ...
    var url = '/index.php/Shop/User/add_store';
...
/*  $('.edit').click(function(){
    ...
    var url = '/index.php/Shop/User/edit_level_save';
    var jump_url = '/index.php/Shop/User/daili_index';
...
/*   $('#add').click(function(){
     ...
     var pid = $('#pid').val();
     var url = '/index.php/Shop/User/add';
  ...
  $('.del').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Shop/User/del';
     var jump_url = '/index.php/Shop/User/store';
     var data={'id':id}
     layer.open({
        type:0,
