...
<!-- 
  ...
  <div class="page-container row-fluid">
          ...
          <div class="span12">
            ...
            <div class="portlet box blue">
              ...
              <div class="clearfix" style="height: 50px;">
                <div class="btn-group">
                  <button type="button" class="btn green" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#heixao_mem" id="add_a">
                  新增核销员
                  </button>
                </div>
              </div>
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        <td style="text-align: center;"><?php echo ($vo["wx_name"]); ?></td>
                        <td style="text-align: center;">
                         <?php if($vo[sex] == 1): ?>男<?php endif; ?>
                         <?php if($vo[sex] == 2): ?>女<?php endif; ?>
                        </td>
                        <td style="text-align: center;">
                         <img src="<?php echo ($vo["wx_pic"]); ?>" alt="" width="60" height="60">
                        </td>
                        <td style="text-align: center;">
                          <?php echo ($vo["address"]); ?>
                        </td>
                        <td style="text-align: center;">
                           <?php if($vo[hexiao_status] == 1): ?><button type="button" class="btn green mini suo" attr-id="<?php echo ($vo["id"]); ?>">正常</button><?php endif; ?>
                           <?php if($vo[hexiao_status] == 0): ?><button type="button" class="btn red mini jie" attr-id="<?php echo ($vo["id"]); ?>">禁止</button><?php endif; ?>
                        </td>
                        <td style="text-align: center;"><?php echo (date("y-m-d",$vo["hexiao_time"])); ?></td>
                        <td style="text-align: center;">
    ...
    $('.suo').click(function(){
     ...
     var url = "/index.php/Shop/User/suo_hexiao";
     var jump_url = "/index.php/Shop/User/hexiao";
     var data = {'id':id};
    ...
    $('.jie').click(function(){
     ...
     var url = "/index.php/Shop/User/jie_hexiao";
     var jump_url = "/index.php/Shop/User/hexiao";
     var data = {'id':id};
     $.post(url,data,function(result){
      if(result.status==1){
  ...
  $('.del').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Shop/User/del_hexiao';
     var jump_url = '/index.php/Shop/User/hexiao';
     var data={'id':id}
     layer.open({
        type:0,
...
<!-- ======= -->
         ...
         <table width="400" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" class="table">
                ...
                <tr>
                   ...
                   <img src="/index.php/Shop/User/hexiao_code" alt="">
                   </td>
                 </tr>
...
<!--=================================-统计数据===========================-->
  ...
  <script>
    ...
    var url="/index.php/Shop/User/bdel";
