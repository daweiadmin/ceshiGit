...
<!-- 
  ...
  <div class="page-container row-fluid">
    ...
    <div class="page-content">
          ...
          <div class="span12">
            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-title">
                ...
                <div class="caption"><i class="icon-edit"></i>商户列表</div>
              ...
              <div class="portlet-body">
                ...
                <div class="clearfix" style="height: 50px;">
                  ...
                  <div class="btn-group">
                     <a href="/index.php/Shop/Shop/add_daili"><button type="button" class="btn blue ">新增商户</button> </a>
                    ...
                    <!--  <button id="delall" class="btn red" style="margin-left:20px;">
                     ...
                     <form class="sidebar-search" style="display:inline-block; float:right; margin-left:10px; " method="post" action="/index.php/Shop/Shop/daili_index">

                       <input type="text" placeholder="商户昵称 / 姓名" name="search" style="width:200px; display:inline-block; height:24px;"/>
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        ...
                        <td style="text-align: center;">0.00元</td>
                         <td style="text-align: center;">0.00元</td>
                         <td style="text-align: center;">0.00元</td>
                        <td style="text-align: center;"><?php echo ($vo["name"]); ?></td>
                        <td style="text-align: center;"><?php echo ($vo["link_man"]); ?></td>
                        <td style="text-align: center;"><?php echo ($vo["phone"]); ?></td>
                        <td style="text-align: center;"><?php echo (date("y-m-d H:i",$vo["time"])); ?></td>
                        <td style="text-align: center;"><?php echo (shop_name($vo["parentid"])); ?></td>
                          <td style="text-align: center;">
                          <?php if($vo[status] == 1): ?><button type="button" class="btn green suo mini" attr-id="<?php echo ($vo["id"]); ?>">正常</button><?php endif; ?>
                          <?php if($vo[status] == -1): ?><button type="button" class="btn red jie mini" attr-id="<?php echo ($vo["id"]); ?>">冻结</button><?php endif; ?>
                           <?php if($vo[status] == -2): ?><button type="button" class="btn red mini jujue" attr-val="<?php echo ($vo["content"]); ?>">审核不通过</button><?php endif; ?>
                           <?php if($vo[status] == 0): ?><span style="color: red;">未审核</span><?php endif; ?>
                        </td>                             
                        <td style="text-align: center;">
                          <!-- <button type="button" class="btn green mini" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#level<?php echo ($vo["id"]); ?>">详情</button> -->
                          <button type="button" class="btn blue mini click_shop" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#fenpei">分配码段</button>
                           <button type="button" class="btn red change_pwd mini" attr-id="<?php echo ($vo["id"]); ?>">重置密码</button>
                           <a href="/index.php/Shop/Shop/edit_daili?shop_id=<?php echo ($vo["id"]); ?>"><button type="button" class="btn green mini">修改</button></a>
                          <a href="/index.php/Shop/Shop/login_change?login_id=<?php echo ($vo["id"]); ?>"> 
                             <button type="button" class="btn yellow mini " attr-id="<?php echo ($vo["id"]); ?>">管理</button>
                            </a> 
                        </td>
      ...
      <script type="">
        $('.guanli').click(function(){
         var a = $('.guanli').index(this);
         var id = $('.guanli').eq(a).attr('attr-id');
         var url = "/index.php/Shop/Shop/aaaaa";
         var jump_url = "/index.php/Shop/index/index";
         var data = {'login_id':id};
    ...
    $('.suo').click(function(){
     ...
     var url = "/index.php/Shop/Shop/suo";
     var jump_url = "/index.php/Shop/Shop/store";
     var data = {'id':id};
     $.post(url,data,function(result){
      if(result.status==1){
    ...
    $('.jie').click(function(){
     ...
     var url = "/index.php/Shop/Shop/jie";
     var jump_url = "/index.php/Shop/Shop/store";
     var data = {'id':id};
     $.post(url,data,function(result){
      if(result.status==1){
  ...
  $('.change_pwd').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Shop/Shop/change';
     var jump_url = '/index.php/Shop/Shop/store';
     var data={'id':id}
     layer.open({
        type:0,
...
<script>
    $('#click_fenpei').click(function(){
     ...
     var url = "/index.php/Shop/Shop/fenpei";
     var jump_url = "/index.php/Shop/Shop/store";
     $.post(url,data,function(result){
...
<!-- <?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="modal fade" id="level<?php echo ($vo["id"]); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
=======
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td style="border:1px #ccc solid;" height="20" width="200" align="center">
                       <?php echo (date("y-m-d H:i",$vo["end_time"])); ?>
                    </td>
                 </tr>
...
<script type="text/javascript">
  $('.edit').click(function(){
    ...
    var url = '/index.php/Shop/Shop/edit_level_save';
    var jump_url = '/index.php/Shop/Shop/store';
...
/*  $('.edit').click(function(){
    ...
    var level = $('.lev').eq(a).val();
    var url = '/index.php/Shop/Shop/edit_level_save';
    var jump_url = '/index.php/Shop/Shop/daili_index';
    var data = {'id':id,'level':level};
    $.post(url,data,function(res){
        if (res.status == 1) {
            dialog.success(res.message,jump_url);
...
/*   $('#add').click(function(){
     ...
     var pid = $('#pid').val();
     var url = '/index.php/Shop/Shop/add';
     var jump_url = '/index.php/Shop/Shop/index';
  ...
  $('.del').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Shop/Shop/del';
     var jump_url = '/index.php/Shop/Shop/store';
     var data={'id':id}
     layer.open({
        type:0,
    ...
    var url="/index.php/Shop/Shop/bdel";
    var jump_url="/index.php/Shop/Shop/index";
        layer.open({
        type:0,
        title:'批量删除',
