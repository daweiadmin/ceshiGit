...
<!-- 
  ...
  <div class="page-container row-fluid">
          ...
          <div class="span12">
            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-title">
                ...
                <div class="caption"><i class="icon-edit"></i>客户信息统计</div>
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        <td style="text-align: center;"><?php echo (activity_name($vo["activity_id"])); ?></td>
                        <td style="text-align: center;"><?php echo (member_wxname($vo["member_id"])); ?>  <?php echo (member_wxsex($vo["member_id"])); ?></td>
                        <td style="text-align: center; "><?php echo (userdata_string($vo["member_id"])); ?></td>
    ...
    $('.suo').click(function(){
     ...
     var url = "/index.php/Shop/Activity/suo";
    ...
    $('.jie').click(function(){
     ...
     var url = "/index.php/Shop/Activity/jie";
     var jump_url = "/index.php/Shop/Activity/daili_index";
     var data = {'id':id};
     $.post(url,data,function(result){
      if(result.status==1){
  ...
  $('.change_pwd').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Shop/Activity/change';
     var jump_url = '/index.php/Shop/Activity/daili_index';
     var data={'id':id}
     layer.open({
        type:0,
