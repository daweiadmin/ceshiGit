...
<!-- 
  ...
  <div class="page-container row-fluid">
              ...
              <div class="portlet-body">
                ...
                <div class="clearfix" style="height: 50px;">
                  ...
                  <div class="btn-group">
                      ...
                      <button type="button" class="btn blue " attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#sum">新增码段</button>
                    ...
                    <!--  <button id="delall" class="btn red" style="margin-left:20px;">
                     ...
                     <form class="sidebar-search" style="display:inline-block; float:right; margin-left:10px; " method="post" action="/index.php/Admin/Code/daili_index">

                       <input type="text" placeholder="批号 / 所属商户" name="search" style="width:200px; display:inline-block; height:24px;"/>
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        ...
                        <td style="text-align: center;">
                          <?php if($vo['shop_id'] == 0): ?><span style="color:red;">未分配</span>
                          <?php else: ?>
                            <span style="color:blue;"><?php echo (shop_name($vo["shop_id"])); ?></span><?php endif; ?>
                         </td> 
                         <td style="text-align: center;">
                          <?php if($vo['activity_id'] == 0): ?><span style="color:red;">未分配</span>
                          <?php else: ?>
                            <span style="color:blue;"><?php echo (activity_name($vo["activity_id"])); ?></span><?php endif; ?>
                         </td> 
                        ...
                        <td style="text-align: center;">
                         ...
                         <!--  <button type="button" class="btn blue sel" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#sum<?php echo ($vo["id"]); ?>">查看名下码段数量</button> -->
                         <!--  <button type="button" class="btn blue mini" attr-id="<?php echo ($vo["id"]); ?>">分配码段</button>
                          <button type="button" class="btn red change_pwd mini" attr-id="<?php echo ($vo["id"]); ?>">重置密码</button>
                          <a href="/index.php/Admin/Code/edit_daili?shop_id=<?php echo ($vo["id"]); ?>"><button type="button" class="btn green mini">修改</button></a>
                          <button type="button" class="btn yellow mini" attr-id="<?php echo ($vo["id"]); ?>">管理</button> -->
                         <!--   <?php if($vo['status'] == 0): ?><button type="button" class="btn black suo" attr-id="<?php echo ($vo["id"]); ?>">冻结</button>
                          <?php else: ?>
                            <button type="button" class="btn yellow jie" attr-id="<?php echo ($vo["id"]); ?>">解冻</button><?php endif; ?> -->
                        </td>
    ...
    $('.suo').click(function(){
     ...
     var url = "/index.php/Admin/Code/suo";
     var jump_url = "/index.php/Admin/Code/daili_index";
     var data = {'id':id};
    ...
    $('.jie').click(function(){
     ...
     var url = "/index.php/Admin/Code/jie";
     var jump_url = "/index.php/Admin/Code/daili_index";
     var data = {'id':id};
     $.post(url,data,function(result){
      if(result.status==1){
  ...
  $('.change_pwd').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Admin/Code/change';
     var jump_url = '/index.php/Admin/Code/daili_index';
     var data={'id':id}
     layer.open({
        type:0,
...
<script type="text/javascript">
  $('.kai').click(function(){
   ...
   // alert(chai_num);
    var url = '/index.php/Admin/Code/chaifen';
    var jump_url = '/index.php/Admin/Code/index';
...
<script type="text/javascript">
  $('#addcode').click(function(){
    ...
    //alert(shuliang);
    var url = '/index.php/Admin/Code/add';
    var jump_url = '/index.php/Admin/Code/index';
...
/*   $('#add').click(function(){
  ...
  $('.del').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Admin/Code/del';
     var jump_url = '/index.php/Admin/Code/index';
     var data={'id':id}
     layer.open({
        type:0,
    ...
    var url="/index.php/Admin/Code/bdel";
    var jump_url="/index.php/Admin/Code/index";
        layer.open({
        type:0,
        title:'批量删除',
