            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-body">
                ...
                <div class="clearfix" style="height: 50px;">
                  ...
                  <div class="btn-group">
                     <a href="/index.php/Admin/Shop/add_daili"><button type="button" class="btn blue ">新增代理</button> </a>
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                  ...
                  <tbody>
                      <?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        ...
                        <td style="text-align: center;"><?php echo (level($vo["type"])); ?></td>
