  ...
  <div class="page-container row-fluid">
                ...
                <div class="clearfix" style="height: 50px;">
                  ...
                  <div class="btn-group">
                    <!-- <button type="button" class="btn green" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#add_activity" id="add_a">新增活动</button> -->
                     ...
                     <form class="sidebar-search" style="display:inline-block; float:right; margin-left:10px; " method="get" action="/index.php/Admin/Activity/index">
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        ...
                        <td style="text-align: center; color:blue;"><?php echo (shop_name($vo["shop_id"])); ?></td>
                        ...
                        <td style="text-align: center;">
                          <button type="button" class="btn green mini block_box1" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#sum<?php echo ($vo["id"]); ?>">详情</button>
                        <?php if($vo[activity_code] == ''): ?><button type="button" class="btn blue mini set_code"  attr-id="<?php echo ($vo["id"]); ?>">生成活动二维码</button> 
                         <?php else: ?>
                          <button type="button" class="btn yellow mini block_box2" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#activity_code<?php echo ($vo["id"]); ?>">查看活动二维码</button><?php endif; ?>
                        </td>
   ...
   <script type="">
      ...
      $('.set_code').click(function(){
       ...
       var url = "/index.php/Admin/Activity/set_activity_code";
    ...
    $('.zanting').click(function(){
     ...
     var url = "/index.php/Admin/Activity/act_status";
     var jump_url = "/index.php/Admin/Activity/index";
...
<!-- ======= -->
         ...
         <form class="form-horizontal" id="form_code" action="/index.php/Admin/Activity/add" method="post" enctype="multipart/form-data" >
          <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
...
<script>
  ...
  function fenpei_maduan(){
    ...
    $('#click_fenpei').click(function(){
     ...
     var url = "/index.php/Admin/Activity/fenpei";
     var jump_url = "/index.php/Admin/Activity/daili_index";
     $.post(url,data,function(result){
       ...
       if(result.status==1){
        ...
        <!--=================================-模态框===========================-->
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="modal fade" id="activity_code<?php echo ($vo["id"]); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<script type="text/javascript">
  ...
  $('#img5').click(function(){
   ...
   $('#choose').click(function(){
     ...
     var jump_url = '/index.php/Admin/Activity/add?activityId='+activity_type;
  ...
  $('.edit').click(function(){
    ...
    var url = '/index.php/Admin/Activity/edit_level_save';
    var jump_url = '/index.php/Admin/Activity/daili_index';
