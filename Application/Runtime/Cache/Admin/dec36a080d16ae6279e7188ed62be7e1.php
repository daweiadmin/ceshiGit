...
<!-- 
  ...
  <div class="page-container row-fluid">
            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-body">
                ...
                <div class="clearfix" style="height: 50px;">
                  ...
                  <div class="btn-group">
                     <a href="/index.php/Admin/Shop/add_daili"><button type="button" class="btn blue ">新增商户</button> </a>
                    ...
                    <!--  <button id="delall" class="btn red" style="margin-left:20px;">
                     ...
                     <form class="sidebar-search" style="display:inline-block; float:right; margin-left:10px; " method="post" action="/index.php/Admin/Shop/daili_index">
                  ...
                  <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                        ...
                        <td style="text-align: center;"><?php echo ($vo["money"]); ?>元</td>
                         <td style="text-align: center;"><?php echo (chongzhi_total($vo["id"])); ?>元</td>
                         <td style="text-align: center;"><?php echo (act_total($vo["id"])); ?>元</td>
                        ...
                        <td style="text-align: center;"><?php echo (shop_name($vo["parentid"])); ?></td>
                         <td style="text-align: center;">
                          ...
                          <button type="button" class="btn blue mini click_shop" attr-id="<?php echo ($vo["id"]); ?>" data-toggle="modal" href="#fenpei">分配码段</button>
                           ...
                           <a href="/index.php/Admin/Shop/edit_daili?shop_id=<?php echo ($vo["id"]); ?>"><button type="button" class="btn green mini">修改</button></a>
                            <a href="http://redbag.lingcheng888.com/index.php/Shop/index/index?admin_shop_id=<?php echo ($vo["id"]); ?>">
    ...
    $('.suo').click(function(){
     ...
     var url = "/index.php/Admin/Shop/suo";
     var jump_url = "/index.php/Admin/Shop/store";
     var data = {'id':id};
    ...
    $('.jie').click(function(){
     ...
     var url = "/index.php/Admin/Shop/jie";
     var jump_url = "/index.php/Admin/Shop/store";
     var data = {'id':id};
     $.post(url,data,function(result){
      if(result.status==1){
  ...
  $('.change_pwd').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Admin/Shop/change';
     var jump_url = '/index.php/Admin/Shop/store';
     var data={'id':id}
     layer.open({
        type:0,
...
<script>
    $('#click_fenpei').click(function(){
     ...
     var url = "/index.php/Admin/Shop/fenpei";
     var jump_url = "/index.php/Admin/Shop/store";
     $.post(url,data,function(result){
...
<script type="text/javascript">
  $('.edit').click(function(){
    ...
    var url = '/index.php/Admin/Shop/edit_level_save';
    var jump_url = '/index.php/Admin/Shop/store';
...
/*  $('.edit').click(function(){
    ...
    var level = $('.lev').eq(a).val();
    var url = '/index.php/Admin/Shop/edit_level_save';
    var jump_url = '/index.php/Admin/Shop/daili_index';
    var data = {'id':id,'level':level};
    $.post(url,data,function(res){
        if (res.status == 1) {
            dialog.success(res.message,jump_url);
...
/*   $('#add').click(function(){
     ...
     var pid = $('#pid').val();
     var url = '/index.php/Admin/Shop/add';
     var jump_url = '/index.php/Admin/Shop/index';
  ...
  $('.del').click(function(){
     ...
     //alert(id);
     var url = '/index.php/Admin/Shop/del';
     var jump_url = '/index.php/Admin/Shop/store';
     var data={'id':id}
     layer.open({
        type:0,
    ...
    var url="/index.php/Admin/Shop/bdel";
    var jump_url="/index.php/Admin/Shop/index";
        layer.open({
        type:0,
        title:'批量删除',
