$(function () {
    ...
    $(function () {
        if (!!$.cookie("eggIndex")) {//如果存在cookie，也就是有金蛋被砸开
            ...
            for (var i = 0; i < openArr.length; i++) {
                ...
                $egg.eq(parseFloat(openArr[i])).prop("src", "/Public/red_bag/jindan/goldeggs/image/step3.png");
    ...
    function eggChange(i) {
        ...
        setTimeout(function () {
            $hammer.addClass("hit");
            $egg.eq(i).prop("src", "/Public/red_bag/jindan/goldeggs/image/step1.png");
            setTimeout(function () {
                $egg.eq(i).prop("src", "/Public/red_bag/jindan/goldeggs/image/step2.png");
            }, 300);
            setTimeout(function () {
                $egg.eq(i).prop("src", "/Public/red_bag/jindan/goldeggs/image/step3.png");
