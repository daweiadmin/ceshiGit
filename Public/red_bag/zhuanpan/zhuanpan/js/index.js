$(function () {
    ...
    function clickFn() {
        ...
        var data = parseInt($('#de_prize').val());//获取的参数转化为数字
        //alert(data);
        switch (data) {//中奖概率，可控。根据得到的随机数控制奖品
            case 1://谢谢参与
                rotateFn(1, 60, tips[4]);
                break;
            case 2://100
                rotateFn(2, 120, tips[1]);
                break;
            case 3://豪华
                rotateFn(3, 180, tips[0]);
                break;
            case 4://20
                rotateFn(4, 240, tips[3]);
                break;
            case 5://50
                rotateFn(5, 300, tips[2]);
                break;
            case 6://豪华
                rotateFn(6, 360, tips[0]);
                break;
        }
    }
